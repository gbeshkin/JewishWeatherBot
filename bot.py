...
RADAR_LINES = [
    ...
    "Сигналы за сутки: **{n}** (включая новости/анонсы/обсуждения).",
    "Количество найденных материалов за 24ч: **{n}**.",
    "Суточный уровень шума по сигналам: **{n}**.",
    "Показания датчика: **{n}** упоминаний за последние 24 часа.",
]
